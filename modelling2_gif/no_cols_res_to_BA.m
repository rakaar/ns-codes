...
for tok=1:n_tokens
    ...
    thalamic_cols_spike_rates(9,:,token_second_half_start_time:token_second_half_end_time) = lamda_b;
    thalamic_cols_spike_rates(10,:,token_second_half_start_time:token_second_half_end_time) = lamda_m;
    thalamic_cols_spike_rates(11,:,token_second_half_start_time:token_second_half_end_time) = lamda_a;
    thalamic_cols_spike_rates(12,:,token_second_half_start_time:token_second_half_end_time) = lamda_m;
    thalamic_cols_spike_rates(13,:,token_second_half_start_time:token_second_half_end_time) = lamda_b;
    thalamic_cols_spike_rates(14,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
    thalamic_cols_spike_rates(15,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
    thalamic_cols_spike_rates(16,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
    thalamic_cols_spike_rates(17,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
...
save('response_to_BA.mat', 'response_to_BA')