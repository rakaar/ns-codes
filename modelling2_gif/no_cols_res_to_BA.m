clear all
tic
response_to_BA = zeros(100,5);
shuffled_neuron_types = load("D:\no_cols_1000tokens\batch_1.mat", 'shuffled_neuron_types').shuffled_neuron_types;
weight_matrix = load("D:\no_cols_1000tokens\batch_496.mat").weight_matrix;
for rep=1:5
n_exc = 80;
n_pv = 12; 
n_som = 8;
...
for tok=1:n_tokens
    ...
    thalamic_cols_spike_rates(2,:,token_second_half_start_time:token_second_half_end_time) = lamda_3;
    thalamic_cols_spike_rates(3,:,token_second_half_start_time:token_second_half_end_time) = lamda_2;
    thalamic_cols_spike_rates(4,:,token_second_half_start_time:token_second_half_end_time) = lamda_1;
    thalamic_cols_spike_rates(5,:,token_second_half_start_time:token_second_half_end_time) = lamda_2;
    thalamic_cols_spike_rates(6,:,token_second_half_start_time:token_second_half_end_time) = lamda_3;
    thalamic_cols_spike_rates(7,:,token_second_half_start_time:token_second_half_end_time) = lamda_4;
...
rand_weights_thalamus_to_exc = load("D:\no_cols_1000tokens\batch_1.mat",'rand_weights_thalamus_to_exc').rand_weights_thalamus_to_exc;
...
thalamus_to_exc_shuffle_indices = load("D:\no_cols_1000tokens\batch_1.mat", 'thalamus_to_exc_shuffle_indices').thalamus_to_exc_shuffle_indices;
...
thalamus_to_pv_shuffle_indices = load("D:\no_cols_1000tokens\batch_1.mat",'thalamus_to_pv_shuffle_indices').thalamus_to_pv_shuffle_indices;
...
thalamus_to_som_shuffle_indices = load("D:\no_cols_1000tokens\batch_1.mat", 'thalamus_to_som_shuffle_indices').thalamus_to_som_shuffle_indices;
...
response_to_BA(:,rep) = mean(spikes,2);
disp(rep)
end % end of rep
toc