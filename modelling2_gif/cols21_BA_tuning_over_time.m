...
n_columns = 21;
n_steps = 1;
initial_ba_col_spike_rates = zeros(n_steps,n_columns);
starting_bbb = 1;
...
for iter=1:n_iters
    for tok=1:n_tokens
        ...
        lamda(iter,14,:,token_first_half_start_time:token_first_half_end_time) = lamda_a;
        lamda(iter,15,:,token_first_half_start_time:token_first_half_end_time) = lamda_m;
        lamda(iter,16,:,token_first_half_start_time:token_first_half_end_time) = lamda_b;
        ...
        lamda(iter,11,:,token_second_half_start_time:token_second_half_end_time) = lamda_m;
        lamda(iter,12,:,token_second_half_start_time:token_second_half_end_time) = lamda_a;
...
%             disp('*******************token resest***************************')
    ...
    for sub_col=1:n_columns
        initial_ba_col_spike_rates(bbb,sub_col) = mean(col_spike_rates_per_subatch(:,sub_col));
    end

end % end of bbb

save('initial_BA_tuning_over_time.mat', 'initial_ba_col_spike_rates')
