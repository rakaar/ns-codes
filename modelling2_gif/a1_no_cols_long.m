...
% weights
som_reduction_factor = load('batch_1.mat', 'som_reduction_factor').som_reduction_factor; % loading from batch 1 to avoid rechanging
...
thalamus_to_exc_shuffle_indices = load('batch_1.mat', 'thalamus_to_exc_shuffle_indices').thalamus_to_exc_shuffle_indices;
...
thalamus_to_pv_shuffle_indices = load('batch_1.mat','thalamus_to_pv_shuffle_indices').thalamus_to_pv_shuffle_indices;
...
thalamus_to_som_shuffle_indices = load('batch_1.mat', 'thalamus_to_som_shuffle_indices').thalamus_to_som_shuffle_indices;
