...
n_columns = 21;
n_steps = 50;
b_col_spike_rates = zeros(n_steps,n_columns);
...
%             disp('*******************token resest***************************')
    ...
    for sub_col=1:n_columns
        b_col_spike_rates(bbb,sub_col) = mean(col_spike_rates_per_subatch(:,sub_col));
    end

end % end of bbb

save('B_tuning_over_time.mat', 'b_col_spike_rates')
