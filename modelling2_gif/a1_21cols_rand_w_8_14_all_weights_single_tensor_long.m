...
for iter=1:n_iters
    for tok=1:n_tokens
        ...
        lamda(iter,1:7,:,token_first_half_start_time:token_first_half_end_time) = lamda_i;
        ...
        lamda(iter,10,:,token_first_half_start_time:token_first_half_end_time) = lamda_a;
        lamda(iter,11,:,token_first_half_start_time:token_first_half_end_time) = lamda_m;
        lamda(iter,12,:,token_first_half_start_time:token_first_half_end_time) = lamda_b;
        ...
        lamda(iter,18,:,token_first_half_start_time:token_first_half_end_time) = lamda_i;
        lamda(iter,19:25,:,token_first_half_start_time:token_first_half_end_time) = lamda_i;
        ...
        lamda(iter,1:7,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
        lamda(iter,8,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
        ...
        lamda(iter,14,:,token_second_half_start_time:token_second_half_end_time) = lamda_b;
        lamda(iter,15,:,token_second_half_start_time:token_second_half_end_time) = lamda_m;
        lamda(iter,16,:,token_second_half_start_time:token_second_half_end_time) = lamda_a;
        lamda(iter,17,:,token_second_half_start_time:token_second_half_end_time) = lamda_m;
        lamda(iter,18,:,token_second_half_start_time:token_second_half_end_time) = lamda_b;
        lamda(iter,19:25,:,token_second_half_start_time:token_second_half_end_time) = lamda_i;
